...
### 1. Violates the [bijection principle](Theory\The One and Only Software Design Principle) 

As we saw in previous articles, every object in our computable model has to be [mapped](Theory\What is (wrong with) software) on a **1 to 1** relationship with a real-world entity.
