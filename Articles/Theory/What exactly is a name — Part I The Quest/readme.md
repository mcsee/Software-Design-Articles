...
Names are very important. They indicate the role that links the objects with their corresponding real entity in [MAPPER](Theory\What is (wrong with) software).

[What is (wrong with) software?](Theory\What is (wrong with) software)

Through this [bijective](Theory\The One and Only Software Design Principle) relationship we will know who he is representing in the real world.
