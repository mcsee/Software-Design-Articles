...
When you chase that number, you write tests that call methods without checking meaningful results.
...
This is vanity coverage: cosmetic metrics that hide real problems, just like brushes that make surfaces look smooth without fixing what is underneath.
...
High coverage combined with many surviving mutants signals vanity coverage.

You can also search for assertion-free tests, single `assertNotNull()` assertions, or tests that pass when you delete the production method body.

# Exceptions 🛑

Smoke tests that call endpoints to verify the system starts are acceptable without detailed assertions.

These work when they complement a meaningful test suite, not replace it.
...
When a test covers a line without verifying observable behavior, you break the [bijection](https://github.com/mcsee/Software-Design-Articles/tree/main/Articles/Theory/The%20One%20and%20Only%20Software%20Design%20Principle/readme.md) between your test suite and the [MAPPER](https://github.com/mcsee/Software-Design-Articles/tree/main/Articles/Theory/What%20is%20(wrong%20with)%20software/readme.md) specification.

Coverage tools measure "lines executed," not "behaviors verified."

Chasing coverage without [bijection](https://github.com/mcsee/Software-Design-Articles/tree/main/Articles/Theory/The%20One%20and%20Only%20Software%20Design%20Principle/readme.md) produces a suite that looks complete but misses real requirements.

# AI Generation 🤖

AI code generators sometimes produce vanity coverage.

When you ask "add tests to reach 80% coverage," the AI writes tests that call methods and assert trivially true facts.

AI tools optimize for the metric, not for behavior verification.

# AI Detection 🧲

AI can detect vanity coverage with specific instructions.

You can prompt: "Find tests with no meaningful assertions" or "Find tests that pass when I delete the production method body."

Without those instructions, most AI tools treat a passing test as a good test.
